    ...
    if($operacao == 'notified'){
      $mail->msgHTML(
        mb_convert_encoding(
          ...
          str_replace('%CREATED%', !empty($ticket[$quote . "ticket_date_ini" . $quote]) ? date_format(date_create($ticket[$quote . "ticket_date_ini" . $quote]),"d/m/Y") : "",
          str_replace('%FINALIZED%', !empty($ticket[$quote . "ticket_date_fin" . $quote]) ? date_format(date_create($ticket[$quote . "ticket_date_fin" . $quote]),"d/m/Y") : "",
          str_replace('%DEADLINE_DATE%', !empty($ticket[$quote . "deadline_date" . $quote]) ? date_format(date_create($ticket[$quote . "deadline_date" . $quote]),"d/m/Y") : "",
